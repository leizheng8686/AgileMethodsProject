...
public class readGEDCOM {
	...
	public void read(File proj1){
		File proj2 = new File("P02-LeiZheng.txt");
		BufferedReader reader = null;
		BufferedWriter writer = null;
		List<String> list0 = new ArrayList<>();
		list0.add("INDI");list0.add("FAM");list0.add("HEAD");
		list0.add("TRLR");list0.add("NOTE");
		List<String> list1 = new ArrayList<>();
		list1.add("NAME");list1.add("SEX");list1.add("BIRT");
		list1.add("DEAT");list1.add("FAMC");list1.add("FAMS");
		list1.add("MARR");list1.add("HUSB");list1.add("WIFE");
		list1.add("CHIL");list1.add("DIV");		
		List<String> list2 = new ArrayList<>();
		list2.add("DATE");
		try{
			reader = new BufferedReader(new FileReader(proj1));
			writer = new BufferedWriter(new FileWriter(proj2));
			String str = null;
